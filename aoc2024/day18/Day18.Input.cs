...
public static partial class Day18
{
    ...
    {
        public static (int, int, string) GetInput(InputSelector inputSelector)
        {
        ...
        private static (int, int, string) GetExample1Input() =>
            (7, 12, """
                5,4
                4,2
                4,5
        ...
        private static (int, int, string) GetMyPuzzleInput() =>
            (71, 1024, """
                 11,57
                 16,7
                 21,58
