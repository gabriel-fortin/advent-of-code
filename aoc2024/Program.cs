...
using Advent_of_Code_2024.day24;
using Advent_of_Code_2024.day25;
...
Console.WriteLine($"Day 16, part 1, my input: {Day16.Part1(MyInput)}");
...
Console.WriteLine($"Day 18, part 2, example 1: {Day18.Part2(Example1)}");
...
Console.WriteLine($"Day 19, part 2, example 1: {Day19.Part2(Example1)}");
Console.WriteLine($"Day 19, part 2, my input: {Day19.Part2(MyInput)}");
...
Console.WriteLine($"Day 24, part 1, example 1: {Day24.Part1(Example1)} (expected 4)");
Console.WriteLine($"Day 24, part 1, example 2: {Day24.Part1(Example2)} (expected 2024)");
Console.WriteLine($"Day 24, part 1, my input: {Day24.Part1(MyInput)}");
Day24.Part2(MyInput);

Console.WriteLine("== Day 25 ==");
Console.WriteLine($"Day 25, part 1, example 1: {Day25.Part1(Example1)} (expected 3)");
Console.WriteLine($"Day 25, part 1, my input: {Day25.Part1(MyInput)}");
